...
bash scripts/phase-n3d/aiostreams-config.sh get > /tmp/aios-backup.json
bash scripts/phase-n3d/aiostreams-config.sh diff   # current vs repo target patch
bash scripts/phase-n3d/aiostreams-config.sh apply  # merge target patch + PUT
```
...
- Operator UI: `scripts/phase-n3d/configure-aiostreams.md`

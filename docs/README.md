...
| VOD recommendations | `f24fcda` is latest-only and Pi-served: deterministic `vod-content-profile-v2`, immutable compatible StoryDNA overlays, local Household Story Frontier ranking, cyclic cached six-card dealing, and cache-only active-tab category Shuffle. Complete 5,671/3,874 accounting and 224/229 reserves pass; exact-SHA five-X proof changed every category rail and `For You` at p95 140 ms without rank/provider work. Human thematic judgment remains open |
| YouTube recommendations | `a60d1c0` / `youtube-household-v2.4` is Pi-served for the authenticated India account with 55 authoritative subscriptions plus 2,872 normalized Takeout watch events (2,548 unique videos) and six Mango-local anchors. Meaningful watches suppress the exact video for 30 days, then may reappear while continuing to inform taste. Generation-13 reserves are 120/63/13/120 and More Like is thematic; 50-X p95 is 106 ms with no recent-watch leaks or quota work. Exported Search history remains unused |

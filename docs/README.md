...
| VOD recommendations | `7a8bc1b` is latest-only and Pi-served: deterministic `vod-content-profile-v2`, immutable compatible StoryDNA overlays, local Household Story Frontier ranking, and cyclic cached six-card dealing. Complete 5,671/3,874 accounting, 224/229 reserves, and 100-X-per-tab cache/latency proof pass; human thematic judgment remains open |

...
| VOD recommendations | `7ed5a31` is latest-only and Pi-served: deterministic `vod-content-profile-v2`, immutable compatible StoryDNA overlays, local Household Story Frontier ranking, cyclic cached six-card dealing, and cached active-tab category Shuffle. Complete 5,671/3,874 accounting and 224/229 reserves pass; 30 exact-SHA shuffles changed every category rail and `For You` at p95 71.4 ms Movies / 47.9 ms TV without rank/provider work. Human thematic judgment remains open |
| YouTube recommendations | `7ed5a31` / `youtube-household-v2.5` is Pi-served for the authenticated India account with 55 authoritative subscriptions plus 2,872 normalized Takeout events (2,548 unique videos). Those are the only taste/acquisition inputs; Mango-local viewing is History/progress plus a 30-day exact-video cooldown. Generation-14 reserves are 120/32/9/120 and More Like is thematic; 30-X p95 is 82.9 ms with stable History and no quota work. Exported Search history remains unused |

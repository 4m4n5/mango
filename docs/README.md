...
| YouTube recommendations | `7a8bc1b` is Pi-served for the authenticated India account with 55 authoritative subscriptions plus 2,872 normalized Takeout watch events (2,548 unique videos) and six Mango-local anchors. Reserves are 120/59/13/120 and More Like is currently thematic. Exact exclusions and chronological History are startup/refresh snapshots, giving final-generation 100-X p95 73 ms with no provider/quota work; exported Search history remains unused by recommendation design |

...
| [kodi-youtube-setup.md](kodi-youtube-setup.md) | YouTube addon + API keys |
| [DESIGN.md](DESIGN.md) | V1 spec |
| [tasks/](tasks/) | Historical implementation specs |

**Agents:** [`../AGENTS.md`](../AGENTS.md) · **Scripts:** [`../scripts/README.md`](../scripts/README.md) · **TV polish:** `$mango-tv-box-expert`

**New SD card:** PHASE0.md § First-time Pi.

...
**Branch:** `feat/native-experience` — native TV home. **Implemented:** M1–M4 · Mango-owned library · native YouTube base · Search · voice/phone librarian · Reliability Center · native mpv HUD/Streams · latest-only Household recommendations: progressive VOD content profiles/Story Frontier and provenance-gated YouTube v2. **Recommendation rollout target:** `772b3d58b53208a278da4e9d5281b46f88054b8e` closes the source mode/ownership/Shuffle/active-pointer/test blockers and makes playability status report migration 14 truthfully. **Latest recorded Pi state:** contained at `3ef1b20` with VOD/YouTube/teacher/TMDB off and 1,096 StoryDNA rows preserved; target deployment, Pi gates, serve, and couch proof remain open. **Active:** home shadow deployment and independent VOD/YouTube promotion · harden deploy helpers · implement intentional display sleep/CEC · harden playback/provider/grow paths · obtain exact-revision couch/controller/target-TV proof. **Next:** M6.4 no-SSH wizard · final release acceptance · merge to `main`. Read [STATUS.md](docs/STATUS.md) before treating source, Mac tests, Pi deployment, automated gates, or human couch proof as equivalent.

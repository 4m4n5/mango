...
**Branch:** `main`. Current deployed evidence: [docs/STATUS.md](docs/STATUS.md).
...
- `pi-deploy.sh` / `pi-exec-gate.sh` require `main`, fetch, SHA match, and a
...
3. Commit only when asked; push `main`.

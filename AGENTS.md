...
**Branch:** `feat/native-experience` — native TV home. **Implemented:** M1–M4 · Mango-owned library · native YouTube base · Search · voice/phone librarian · Reliability Center · native mpv HUD/Streams · latest-only Household recommendations: progressive VOD content profiles/Story Frontier and provenance-gated YouTube v2. **Current release line:** `e7b7c57` adds canonical Saved placement plus YouTube v2.7; `2a93582` sanitizes compatibility-play failures; `5a0dc7e` optimizes cached Shuffle reads; `04171bb1c771f5fc713d192e50e0fc79e966c3cc` fixes active-rail Reliability accounting. **Latest recorded Pi state:** exact final SHA `04171bb1c771f5fc713d192e50e0fc79e966c3cc`, library migration 18 and YouTube migration 17 applied with `quick_check` OK, Saved tab contamination repaired without user-state loss, YouTube v2.7 generation 22 serving 1,441 candidates, and final targeted library/YouTube/playback checks passing. The standard pre-couch gate passed at `2a93582`; the first full N3c attempt stopped at 31/36 and was not rerun by user direction, so no final-SHA full-gate PASS is claimed. **Active:** human couch recommendation/focus/picture/audio/controller acceptance · harden deploy helpers · implement intentional display sleep/CEC · harden playback/provider/grow paths. **Next:** M6.4 no-SSH wizard · final release acceptance · merge to `main`. Read [STATUS.md](docs/STATUS.md) before treating source, Mac tests, Pi deployment, automated gates, or human couch proof as equivalent.

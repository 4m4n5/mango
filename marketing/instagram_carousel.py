...
def render_01(raw: Path) -> Image.Image:
    ...
    draw_standard_copy(
        img,
        header="your TV.",
        subheader="on your terms.",
        title=("one home for movies, shows,", "YouTube, and live."),
        subtitle=("running on Raspberry Pi 5.",),
    )
...
def render_02(raw: Path) -> Image.Image:
    ...
    draw_standard_copy(
        ...
        subheader="from across streaming.",
        title=("and btw, no ads!",),
        subtitle=("mango inserts none.",),
    )
...
def render_03(raw: Path) -> Image.Image:
    ...
    draw_standard_copy(
        ...
        subheader="across movies, shows, live, and YouTube.",
        title=("one query.",),
        subtitle=("every mango surface.",),
    )
...
def render_04(raw: Path) -> Image.Image:
    ...
    draw_standard_copy(
        img,
        header="watch it at its best.",
        subheader="mango optimizes for your hardware.",
...
def render_05(raw: Path) -> Image.Image:
    ...
    draw_standard_copy(
        img,
        header="rate with fire + water.",
        subheader="get better recommendations.",
        title=("mango learns your taste.",),
        subtitle=("one title at a time.",),
    )
...
def render_06(raw: Path) -> Image.Image:
    ...
    draw_standard_copy(
        ...
        subheader="talk naturally from your phone.",
        title=("describe. discuss. discover.",),
        subtitle=("your final pick opens on the TV.",),
    )
...
def render_07(raw: Path) -> Image.Image:
    ...
    draw_standard_copy(
        ...
        subheader="get meaningful recommendations.",
        title=("ad-free, without Premium.",),
        subtitle=("your regulars, subscriptions, and history—organized.",),
    )
...
def render_08(raw: Path) -> Image.Image:
    ...
    draw_standard_copy(
        img,
        header="wanna know how I built it?",
        subheader="get in touch.",
        title=("want mango?",),
        subtitle=("send me a DM for more information.",),
    )
    draw_tv(img, source(raw, "pi-home-movies.png"), x=80, y=360, width=920)
    return img
...
CARDS: tuple[Card, ...] = (
    ...
    Card(
        ...
        "Pi capture",
        publication_blocker="The claim “ad-free, without Premium.” requires technical substantiation and an explicit platform/legal decision.",
    ),
    Card(
        8,
        "contact",
        render_08,
        ("pi-home-movies.png",),
        "Temporary Pi Home capture",
        limitation="No local photograph of the real Pi enclosure and controller was available.",
        publication_blocker="Replace the temporary TV image with the approved real hardware photograph.",
    ),
)

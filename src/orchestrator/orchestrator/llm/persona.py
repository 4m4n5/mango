...
_TOOL_POLICY = (
    ...
    "if mango_search returns no movie/series hits (empty, or only type tv / tab live), "
    "call mango_search_external (type series or movie as appropriate) before saying not found; "

...
| `series-india-picks` | Active measured sources **173530**, **160359**, and **107457** + small probes for India OTT/provider lists including full Bharat Binge Hindi/Tamil/Telugu/Malayalam/Kannada series variants, JioHotstar, Zee5, SonyLiv, Netflix India, and curated Indian web-series pools | Runtime grow audits showed these three are the only repeat fresh verified-yield India series sources so far. Broad provider/top-rated lists stay as probation probes because they are mostly no-stream, duplicate-heavy, or theme-noisy; **165054** remains demoted after high theme rejection in benchmark grow |
...
| `series-reality-casual` | **84401** + promoted deep pool **147884** + **143024** + **122526** + demoted **63182** + **125320** + **125155** + tiny same-theme gated probes from **88303**, **88434**, **101882**, Cinemeta `top`, and Cinemeta `imdbRating` | 84401 probed 3/3 on Pi and remains primary; 147884 gives depth; generic show charts are only recovery trickles and still must pass the reality/game-show theme gate |

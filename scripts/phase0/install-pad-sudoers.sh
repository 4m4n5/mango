...
# Run on the Pi interactively: sudo bash scripts/phase0/install-pad-sudoers.sh
...
PAD_RUN="/home/${USER_NAME}/mango/scripts/phase0/run-mango-tv-pad.sh"
PAD_PY="/home/${USER_NAME}/mango/scripts/phase0/mango-tv-pad.py"

...
ensure_sudo() {
  ...
  echo "  sudo bash ~/mango/scripts/phase0/install-pad-sudoers.sh" >&2
...
echo ""
echo "Try: bash ~/mango/scripts/phase0/gamepad-fresh-start.sh"
echo "     sudo bash ~/mango/scripts/phase0/install-pad-sudoers.sh  # no password next time"
exit 1

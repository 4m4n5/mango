...
apply       enable target-TV 4K stream policy and mpv couch playback
...
case "$cmd" in
  apply)
    ...
    # 4K: audio when playback-auto matched film refresh; display-vdrop on 60 Hz fallback.

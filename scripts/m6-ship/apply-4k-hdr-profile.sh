...
apply       enable target-TV safe 1080p stream policy and source-matched mpv playback
...
case "$cmd" in
  apply)
    ...
    append_env MANGO_MPV_MATCH_4K_MODE "1920x1080"

...
```bash
bash scripts/phase-n3d/aiostreams-config.sh diff    # vs config/aiostreams-target-patch.json
bash scripts/phase-n3d/aiostreams-config.sh apply   # PUT /api/v1/user
```
...
See [`docs/STACK-PRINCIPLES.md`](../../docs/STACK-PRINCIPLES.md) for layer boundaries.

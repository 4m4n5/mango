...
Usage:
  python3 scripts/phase-n3d/rail-compose.py validate proposal.json
  python3 scripts/phase-n3d/rail-compose.py plan proposal.json
  python3 scripts/phase-n3d/rail-compose.py apply proposal.json [--write]
...
def cmd_apply(args: argparse.Namespace) -> int:
    ...
    print(f"snippet → {snippet_path}")
    print("next: bash scripts/phase-n3d/mdblist-catalog-pipeline.sh check-import")
    return 0

...
bash scripts/m3-play/orchestrator/gate-m3-play-ladder.sh || gate_fail "M3 play-ladder regression"
...
bash scripts/m2-catalog/browse/gate-m2-browse.sh || gate_fail "M2 browse regression"
bash scripts/m1-foundation/gate/gate-m1.sh || gate_fail "M1 regression"

...
#
# Usage:
#   bash scripts/phase-n3c/playability-grow.sh --mode grow|stale|nightly [--preset quick|nightly|overnight]
#   bash scripts/phase-n3c/playability-grow.sh --mode grow --preset quick --detach
#   bash scripts/phase-n3c/playability-grow.sh --status
#
# Modes:
...
bash "$REPO_DIR/scripts/phase-n3c/playability-maintenance.sh" --mode "$MODE" 2>&1 | tee -a "$LOG"

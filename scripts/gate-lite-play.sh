...
# Preference ladder (auto_play_max_attempts, default 12) + obligation floor
# (MANGO_PLAY_OBLIGATION_MAX_ATTEMPTS, default 6) may both run on one /play.
MAX_ATTEMPTS="${MANGO_GATE_LITE_MAX_ATTEMPTS:-18}"

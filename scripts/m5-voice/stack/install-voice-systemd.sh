...
# Run on the Pi: bash ~/mango/scripts/m5-voice/stack/install-voice-systemd.sh
...
chmod +x "$REPO_DIR/scripts/m1-foundation/ui/start-mango-launcher-chromium.sh" 2>/dev/null || true

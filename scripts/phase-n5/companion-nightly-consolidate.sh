...
# Timer: bash scripts/phase-n5/install-companion-nightly-timer.sh (04:30 daily)
# Cron fallback: 30 4 * * * cd ~/mango && bash scripts/phase-n5/companion-nightly-consolidate.sh
set -euo pipefail

...
#
# Usage:
#   bash scripts/m1-foundation/pad/kodi-enable-rpc.sh <username> <password>
#
# Then:
#   bash scripts/m1-foundation/pad/launch-kodi.sh
#   bash scripts/m1-foundation/pad/test-kodi-rpc.sh <username> <password>
...
echo
echo "Next:"
echo "  bash scripts/m1-foundation/pad/launch-kodi.sh"
echo "  sleep 5"
echo "  bash scripts/m1-foundation/pad/test-kodi-rpc.sh ${RPC_USER} '<password>'"

...
#
# Run on the Pi: bash scripts/m1-foundation/pad/map-pro-controller.sh
...
[
  ...
  {"input_combination": [{"type": 1, "code": 316}], "target_uinput": "keyboard", "output_symbol": "key(Control+Alt+m)"},
  {"input_combination": [{"type": 1, "code": 311}], "target_uinput": "keyboard", "output_symbol": "key(Control+Alt+m)"}
]
EOF

...
# Run on the Pi: bash scripts/m1-foundation/pad/set-youtube-api-keys.sh
#
# 1. killall kodi
# 2. Create ~/.config/mango/youtube-api.json (see youtube-api.json.example)
# 3. bash scripts/m1-foundation/pad/set-youtube-api-keys.sh
# 4. bash scripts/m1-foundation/pad/launch-kodi.sh → YouTube → Sign in
...
print("  Next: bash scripts/m1-foundation/pad/launch-kodi.sh → YouTube → Sign in")
PY
